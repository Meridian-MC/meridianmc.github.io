...
function initCopy() {
  ...
  boxes.forEach((box) => box.addEventListener('click', async () => {
...
const CMDK_INDEX = [
  ...
  { label: 'Rules: Behavior', href: '/rules#behavior' },
  { label: 'Rules: Cheats', href: '/rules#cheats' },
  { label: 'Rules: Interaction', href: '/rules#interaction' },
  { label: 'Rules: Claims', href: '/rules#claims' },
  { label: 'Rules: Moderation', href: '/rules#moderation' },
  { label: 'Claims: Claiming', href: '/claims#lands' },
  { label: 'Claims: Nations', href: '/claims#nations' },
  { label: 'Claims: Vassals', href: '/claims#vassals' },
  { label: 'Wars', href: '/war' },
  ...
  { label: 'Economy: Trade', href: '/economy#trade' },
